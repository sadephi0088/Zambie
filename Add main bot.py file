...
# پیام تمسخرآمیز مزاحمین (/mozahem فعال)
mozahem_msgs = [
...
# پیام‌های تخریبی برای دشمنان (/doshaman فعال)
doshaman_msgs = [
